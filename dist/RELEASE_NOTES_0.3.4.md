...
- CUDA repair state is reconciled with the actual PyTorch CUDA state. If CUDA is active, the stale â€śrestart SoundCoreâ€ť prompt disappears automatically.
