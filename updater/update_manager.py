...
PROTECTED_TOP_LEVEL = {"voice_profiles", "output", "songs", ".venv", "venv", ".git", "engine_runtime", "_repair_backups"}
...
pid = int(sys.argv[3])
protected = {"voice_profiles", "output", "songs", ".venv", "venv", ".git", "engine_runtime", "_repair_backups"}
